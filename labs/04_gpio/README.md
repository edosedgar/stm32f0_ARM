...
Вернитесь в основной цикл и напишите код, который будет опрашивать состояние кнопки каждый проход цикла. При после первого нажатия светодиод должен загоратся, после второго потухать.
